...
Build.date = function(node, output) {
  ...
  if ( typeof node.default !== 'undefined' &&
      ...
      return Utils.throwError('@key: %s - default must be a Date.', node.key);
...
Build.boolean = function(node, output) {
  ...
  if ( typeof node.default !== 'undefined' &&
      ...
      return Utils.throwError('@key: %s - default must be a Boolean.', node.key);
...
Build.null = function(node, output) {
  ...
  if ( typeof node.default !== 'undefined' &&
      ...
      return Utils.throwError('@key: %s - default must be Null.', node.key);
...
Build.walk = function(schema, output) {
  ...
  _.forEach(schema, function(node, key) {
    ...
    if (node.type && ~_.indexOf(Schema.types, node.type)) {
      ...
      return Utils.throwError('@key: %s - missing or invalid type.', key);
  });
